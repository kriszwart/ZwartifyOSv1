...
function RAGNode({ data, selected }: NodeProps<any>) {
  ...
  const glowColor = 'rgba(6, 182, 212, 0.5)'
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-3 pb-2 border-b border-cyan-400/20">
          <div
            className="text-cyan-400 text-xl transition-all duration-300"
            style={{
              filter: isActive
          ...
          <div
            className="text-cyan-400 font-mono font-bold text-sm tracking-wider transition-all duration-300"
            style={{
        ...
        <div className="space-y-2 text-xs font-mono">
          <div
            className="text-cyan-300 font-medium transition-all duration-300"
            style={{
              color: isActive ? color : 'rgba(6, 182, 212, 0.9)',
