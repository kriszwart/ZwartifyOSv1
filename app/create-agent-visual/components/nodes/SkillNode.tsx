    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-3 pb-2 border-b border-purple-400/20">
          <div
            className="text-purple-400 text-xl transition-all duration-300"
            style={{
              filter: isActive
          ...
          <div
            className="text-purple-400 font-mono font-bold text-sm tracking-wider transition-all duration-300"
            style={{
        ...
        <div className="space-y-2 text-xs font-mono">
          <div
            ...
            style={{
              color: isActive ? color : 'rgba(168, 85, 247, 0.9)',
