    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-3 pb-2 border-b border-blue-400/20">
          <div
            className="text-blue-400 text-xl transition-all duration-300"
            style={{
              filter: isActive
          ...
          <div
            className="text-blue-400 font-mono font-bold text-sm tracking-wider transition-all duration-300"
            style={{
        ...
        <div className="space-y-2 text-xs font-mono">
          <div
            className="text-blue-300 font-medium transition-all duration-300"
            style={{
              color: isActive ? color : 'rgba(96, 165, 250, 0.9)',
