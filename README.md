...
> **Note:** The demo GIF is available in the `public/` folder. For GitHub display, consider hosting a compressed version (<50MB) on GitHub Releases or an external CDN.
